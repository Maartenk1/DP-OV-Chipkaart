...
public class ReizigerDAOPsql implements ReizigerDAO {
    ...
    public boolean save(Reiziger reiziger) throws SQLException {
        ...
        try {
            PreparedStatement pstmnt2 = conn.prepareStatement("INSERT INTO reiziger (reiziger_id , voorletters, tussenvoegsel, achternaam, geboortedatum) VALUES (?, ?, ?, ?, ?)");
            pstmnt2.setInt(1, reiziger.getId());
            pstmnt2.setString(2, reiziger.getVoorletters());
            if (reiziger.getTussenvoegsel() != null) {
                pstmnt2.setString(3, reiziger.getTussenvoegsel());
            } else {
                pstmnt2.setString(3, null);
            }

            pstmnt2.setString(4, reiziger.getAchternaam());
            pstmnt2.setDate(5, (Date) reiziger.getGeboortedatum());
