...
SELECT DISTINCT uitv.cursus, uitv.begindatum, COUNT(insch.cursus) AS aantal_inschrijvingen  FROM uitvoeringen AS uitv
LEFT JOIN inschrijvingen AS insch ON uitv.cursus = insch.cursus AND uitv.begindatum = insch.begindatum
